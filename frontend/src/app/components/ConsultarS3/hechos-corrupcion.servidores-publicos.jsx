...
const tipoFormulario = "consultar.hechos-corrupcion.servidores-publicos";

export const ListForm7 = () => {
      ...
      <Dialog
        ...
        <DialogActions>
          <Button
            ...
            onClick={() =>
              redirectToRoute(
                `/editar/s3/hechos-corrupcion/servidores-publicos/${selectedRegistro._id}`,
              )
            }>
            Editar
          </Button>
