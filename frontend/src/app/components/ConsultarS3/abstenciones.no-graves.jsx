      ...
      <Dialog
        ...
        <DialogActions>
          <Button
            ...
            onClick={() =>
              redirectToRoute(
                `/editar/s3/abstenciones/no-graves/${selectedRegistro._id}`,
              )
            }>
            Editar
          </Button>
                    ...
                    {S2List.map((registro) => (
                      <TableRow key={registro._id}>
                        ...
                        <TableCell style={{ width: "25%" }} align="left">
                          {registro.absNoGrave.nombres &&
                            registro.absNoGrave.nombres + " "}
                          {registro.absNoGrave.primerApellido &&
                            registro.absNoGrave.primerApellido + " "}
                          {registro.absNoGrave.segundoApellido &&
                          registro.absNoGrave.segundoApellido.sinSegundoApellido ==
                            true
                            ? ""
                            : registro.absNoGrave.segundoApellido.valor}
                        </TableCell>
                        {registro.absNoGrave.entePublico && (
                          <TableCell style={{ width: "25%" }} align="left">
                            {registro.absNoGrave.entePublico.siglas &&
                              registro.absNoGrave.entePublico.siglas}
                          </TableCell>
                        )}
                        <TableCell style={{ width: "15%" }} align="center">
                          ...
                          <Tooltip title="Editar registro" placement="top">
                            <IconButton
                              onClick={() =>
                                redirectToRoute(
                                  `/editar/s3/abstenciones/no-graves/${registro._id}`,
                                )
                              }
                              style={{ color: "#ffe01b" }}>
                              <EditOutlinedIcon />
