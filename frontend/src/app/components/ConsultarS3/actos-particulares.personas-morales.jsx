...
const tipoFormulario = "consultar.actos-particulares.personas-morales";

export const ListForm4 = () => {
      ...
      <Dialog
        ...
        <DialogActions>
          <Button
            ...
            onClick={() =>
              redirectToRoute(
                `/editar/s3/actos-particulares/personas-morales/${selectedRegistro._id}`,
              )
            }>
            Editar
          </Button>
                    ...
                    {S2List.map((registro) => (
                      <TableRow key={registro._id}>
                        ...
                        {registro.graveMorales.entePublico && (
                          <TableCell style={{ width: "25%" }} align="left">
                            {registro.graveMorales.entePublico.siglas &&
                              registro.graveMorales.entePublico.siglas}
                          </TableCell>
                        )}
                        <TableCell style={{ width: "15%" }} align="center">
                          ...
                          <Tooltip title="Editar registro" placement="top">
                            <IconButton
                              onClick={() =>
                                redirectToRoute(
                                  `/editar/s3/actos-particulares/personas-morales/${registro._id}`,
                                )
                              }
                              style={{ color: "#ffe01b" }}>
                              <EditOutlinedIcon />
