  ...
  return (
    <>
      ...
      <Dialog
        ...
        <DialogActions>
          <Button
            ...
            onClick={() =>
              redirectToRoute(
                `/editar/s3/abstenciones/graves/${selectedRegistro._id}`,
              )
            }>
            Editar
          </Button>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader
            title={'FORMATO QUE INDICA LOS DATOS QUE SE INSCRIBIRÁN EN EL SISTEMA NACIONAL DE SERVIDORES PÚBLICOS Y PARTICULARES SANCIONADOS DE LA PLATAFORMA DIGITAL NACIONAL RELACIONADOS CON LAS ABTENCIONES REALIZADAS POR EL TRIBUNAL FEDERAL DE JUSTICIA ADMINISRATIVA.'}
                    ...
                    {S2List.map((registro) => (
                      <TableRow key={registro._id}>
                        ...
                        <TableCell style={{ width: "25%" }} align="left">
                          {registro.absGrave.nombres &&
                            registro.absGrave.nombres + " "}
                          {registro.absGrave.primerApellido &&
                            registro.absGrave.primerApellido + " "}
                          {registro.absGrave.segundoApellido &&
                          registro.absGrave.segundoApellido.sinSegundoApellido ==
                            true
                            ? ""
                            : registro.absGrave.segundoApellido.valor}
                        </TableCell>
                        {registro.absGrave.entePublico && (
                          <TableCell style={{ width: "25%" }} align="left">
                            {registro.absGrave.entePublico.siglas &&
                              registro.absGrave.entePublico.siglas}
                          </TableCell>
                        )}
                        <TableCell style={{ width: "15%" }} align="center">
                          ...
                          <Tooltip title="Editar registro" placement="top">
                            <IconButton
                              onClick={() =>
                                redirectToRoute(
                                  `/editar/s3/abstenciones/graves/${registro._id}`,
                                )
                              }
                              style={{ color: "#ffe01b" }}>
                              <EditOutlinedIcon />
          ...
          <Button
              ...
              variant="contained"
                  ...
                  onClick={() =>
                    redirectToRoute(
                      "/captura/s3/abstenciones/graves",
                    )
                  }>
