...
function MyForm(props) {
  ...
  return (
    <Grid item xs={12}>
      <Card>
        <CardHeader
          title="FORMATO QUE INDICA LOS DATOS QUE SE INSCRIBIRÁN EN EL SISTEMA NACIONAL DE SERVIDORES PÚBLICOS Y PARTICULARES SANCIONADOS DE LA PLATAFORMA DIGITAL NACIONAL RELACIONADOS CON LAS SANCIONES IMPUESTAS A PERSONAS SERVIDORAS PÚBLICAS POR LA COMISÓN DE HECHOS DE CORRUPIÓN."
        />
        <Divider />
        <CardHeader
...
export const CreateRegForm7 = connect(
  mapStateToProps,
  mapDispatchToProps,
)(CreateReg);
