...
import esquemaS3ng from "./jsonschemas-rjsf/s3ng";
import uiS3ng from "./uiSchemas/UI_s3ng";
...
function MyForm(props) {
  ...
  const schema = esquemaS3ng;
  const uiSchema = uiS3ng;
...
export const CreateRegForm2 = connect(
  mapStateToProps,
  mapDispatchToProps,
)(CreateReg);
