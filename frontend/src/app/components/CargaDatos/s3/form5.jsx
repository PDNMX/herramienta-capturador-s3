...
import esquemaS3f from "./jsonschemas-rjsf/s3f";
import uiS3f from "./uiSchemas/UI_s3f";
...
function MyForm(props) {
  ...
  const schema = esquemaS3f;
  const uiSchema = uiS3f;
...
export const CreateRegForm5 = connect(
  mapStateToProps,
  mapDispatchToProps,
)(CreateReg);
