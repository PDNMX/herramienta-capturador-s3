...
import esquemaS3gf from "./jsonschemas-rjsf/s3gf";
import uiS3gf from "./uiSchemas/UI_s3gf";
...
function MyForm(props) {
  ...
  const schema = esquemaS3gf;
  const uiSchema = uiS3gf;
...
export const CreateRegForm3 = connect(
  mapStateToProps,
  mapDispatchToProps,
)(CreateReg);
