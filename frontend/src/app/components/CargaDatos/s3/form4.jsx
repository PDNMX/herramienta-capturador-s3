...
import esquemaS3gm from "./jsonschemas-rjsf/s3gm";
import uiS3gm from "./uiSchemas/UI_s3gm";
...
function MyForm(props) {
  ...
  const schema = esquemaS3gm;
  const uiSchema = uiS3gm;
  ...
  return (
    <Grid item xs={12}>
      <Card>
        <CardHeader
          title="SERVIDORES PÚBLICOS Y PARTICULARES SANCIONADOS DE LA PLATAFORMA DIGITAL NACIONAL RELACIONADOS CON LAS SANCIONES QUE SE ENCUENTREN FIRMES IMPUESTAS A LOS PARTICULARES  (PERSONAS MORALES) VINCULADOS CON FALTAS ADMINISTRATIVAS GRAVES EN TÉRMINOS DE LA LEY GENERAL DE RESPONSABILIDADES ADMINISTRATIVAS."
        />
        <Divider />
        <CardHeader
...
export const CreateRegForm4 = connect(
  mapStateToProps,
  mapDispatchToProps,
)(CreateReg);
