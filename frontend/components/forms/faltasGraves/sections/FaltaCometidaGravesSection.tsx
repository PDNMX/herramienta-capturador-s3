...
import { NormatividadGravesFields } from "./NormatividadGravesFields";

interface FaltaCometidaGravesSectionProps {
  form: any;
  loading: boolean;
}
...
export const FaltaCometidaGravesSection: React.FC<FaltaCometidaGravesSectionProps> = ({
  form,
  loading,
}) => {
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Tipo de falta <span className="text-red-500">*</span></FormLabel>
                    <FormControl>
              ...
              {claveValue === "OTRO" && (
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Especifique el tipo de falta <span className="text-red-500">*</span></FormLabel>
                      <FormControl>
