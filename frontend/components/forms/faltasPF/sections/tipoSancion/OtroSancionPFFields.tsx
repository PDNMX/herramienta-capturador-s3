    ...
    <div className="border-t pt-6 space-y-6">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Llenar este apartado en caso de que la persona fisica sea acreedora a otro tipo de sancion prevista en las leyes locales anticorrupcion de las entidades federativas
        </p>
      </div>
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input
                disabled={loading}
                placeholder="Especifique el tipo de sancion"
                {...field}
              />
            </FormControl>
            <FormDescription>
