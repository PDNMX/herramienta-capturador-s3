...
import { NormatividadPFFields } from "./NormatividadPFFields";

interface FaltaCometidaPFSectionProps {
  form: any;
  loading: boolean;
}
...
export const FaltaCometidaPFSection: React.FC<FaltaCometidaPFSectionProps> = ({
  form,
  loading,
}) => {
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col items-start">
            ...
            <span className="text-xs text-muted-foreground">
              Se pueden registrar múltiples faltas para una misma persona física
            </span>
          </div>
        </div>
      </Button>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Seleccionar el (los) tipo (s) de falta (s) cometida (s) por la persona física sancionada
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
