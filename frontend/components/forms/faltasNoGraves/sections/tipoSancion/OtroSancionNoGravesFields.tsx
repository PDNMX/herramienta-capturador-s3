...
interface OtroSancionNoGravesFieldsProps {
  form: any;
  loading: boolean;
  sancionIndex: number;
}

export const OtroSancionNoGravesFields: React.FC<OtroSancionNoGravesFieldsProps> = ({
  form,
  loading,
  sancionIndex,
}) => {
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input disabled={loading} placeholder="Especifique el tipo de sanción" {...field} />
            </FormControl>
            <FormDescription>
