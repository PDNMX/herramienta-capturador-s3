...
export default function Page({ params }) {
  ...
  const breadcrumbItems = [
    { title: "Editar", link: `/inicio/faltas-administrativas-graves/${faltaId}` },
  ];
            ...
            withToken(
              ...
              readItems("faltas_administrativas_graves", {
                ...
                fields: [
                  ...
                  // tipoSancion.sancionEconomica.sancionEfectivamenteCobrada (M2O)
                  "tipoSancion.sancionEconomica.sancionEfectivamenteCobrada.id",
                  "tipoSancion.sancionEconomica.sancionEfectivamenteCobrada.monto",
                  "tipoSancion.sancionEconomica.sancionEfectivamenteCobrada.moneda",
                  "tipoSancion.sancionEconomica.sancionEfectivamenteCobrada.fechaCobro",
  ...
  return (
    <ScrollArea className="h-full">
      <div className="flex-1 space-y-4 p-5">
        <BreadCrumb items={breadcrumbItems} />
        <FaltasAdministrativasGravesForm initialData={falta} key={faltaId} />
      </div>
    </ScrollArea>
  );
}
